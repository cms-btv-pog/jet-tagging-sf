...
# campaign
campaign_name = "Run2_pp_13TeV_UltraLegacy18"
...
dataset_data_A_ee = od.Dataset(
    ...
    is_data=True,
    n_files=4089,
    keys=["/EGamma/Run2018A-12Nov2019_UL2018-v2/MINIAOD"],
...
dataset_data_B_ee = od.Dataset(
    ...
    is_data=True,
    n_files=1859,
    keys=["/EGamma/Run2018B-12Nov2019_UL2018-v2/MINIAOD"],
    context=campaign_name,
)
...
dataset_data_C_ee = od.Dataset(
    ...
    is_data=True,
    n_files=1832,
    keys=["/EGamma/Run2018C-12Nov2019_UL2018-v2/MINIAOD"],
    context=campaign_name,
)
...
dataset_data_D_ee = od.Dataset(
    ...
    is_data=True,
    n_files=9541,
    keys=["/EGamma/Run2018D-12Nov2019_UL2018-v4/MINIAOD"],
    context=campaign_name,
)
...
dataset_data_A_emu = od.Dataset(
    ...
    is_data=True,
    n_files=525,
    keys=["/MuonEG/Run2018A-12Nov2019_UL2018_rsb-v1/MINIAOD"],
    context=campaign_name,
)
...
dataset_data_B_emu = od.Dataset(
    ...
    is_data=True,
    n_files=269,
    keys=["/MuonEG/Run2018B-12Nov2019_UL2018-v1/MINIAOD"],
    context=campaign_name,
)
...
dataset_data_C_emu = od.Dataset(
    ...
    is_data=True,
    n_files=293,
    keys=["/MuonEG/Run2018C-12Nov2019_UL2018-v1/MINIAOD"],
    context=campaign_name,
)
...
dataset_data_D_emu = od.Dataset(
    ...
    is_data=True,
    n_files=1013,
    keys=["/MuonEG/Run2018D-12Nov2019_UL2018_rsb-v1/MINIAOD"],
    context=campaign_name,
)
...
dataset_data_A_mumu = od.Dataset(
    ...
    is_data=True,
    n_files=1034,
    keys=["/DoubleMuon/Run2018A-12Nov2019_UL2018-v2/MINIAOD"],
    context=campaign_name,
)
...
dataset_data_B_mumu = od.Dataset(
    ...
    keys=[
        ...
        #/DoubleMuon/Run2018B-12Nov2019_UL2018_LowPU-v1/MINIAOD
    ],
    context=campaign_name,
)
...
dataset_data_C_mumu = od.Dataset(
    ...
    is_data=True,
    n_files=510,
    keys=["/DoubleMuon/Run2018C-12Nov2019_UL2018-v2/MINIAOD"],
    context=campaign_name,
)
...
dataset_data_D_mumu = od.Dataset(
    ...
    is_data=True,
    n_files=1875,
    keys=["/DoubleMuon/Run2018D-12Nov2019_UL2018-v3/MINIAOD"],
    context=campaign_name,
)
...
dataset_data_A_mu = od.Dataset(
    ...
    is_data=True,
    n_files=2982,
    keys=["/SingleMuon/Run2018A-12Nov2019_UL2018_rsb-v1/MINIAOD"],
    context=campaign_name,
)
...
dataset_data_B_mu = od.Dataset(
    ...
    is_data=True,
    n_files=1327,
    keys=["/SingleMuon/Run2018B-12Nov2019_UL2018-v2/MINIAOD"],
    context=campaign_name,
)
...
dataset_data_C_mu = od.Dataset(
    ...
    is_data=True,
    n_files=1412,
    keys=["/SingleMuon/Run2018C-12Nov2019_UL2018-v2/MINIAOD"],
    context=campaign_name,
)
...
dataset_data_D_mu = od.Dataset(
    ...
    is_data=True,
    n_files=6139,
    keys=["/SingleMuon/Run2018D-12Nov2019_UL2018-v4/MINIAOD"],
    context=campaign_name,
)
...
dataset_tt_dl = od.Dataset(
    ...
    n_files=1366,
    keys=[
         "/TTTo2L2Nu_TuneCP5_13TeV-powheg-pythia8/RunIISummer19UL18MiniAOD-106X_upgrade2018_realistic_v11_L1v1-v2/MINIAODSIM",
    ],
    context=campaign_name,
)
...
dataset_tt_sl = od.Dataset(
    ...
    n_files=1963,
    keys=[
        "/TTToSemiLeptonic_TuneCP5_13TeV-powheg-pythia8/RunIISummer19UL18MiniAOD-106X_upgrade2018_realistic_v11_L1v1-v2/MINIAODSIM",
    ],
    context=campaign_name,
)
...
dataset_dy_lep_LO_50ToInf = od.Dataset(
    "dy_lep_LO_50ToInf", 2232,
    campaign=campaign,
    n_files=1261,
    keys=[
...
dataset_st_s_lep = od.Dataset(
    ...
    n_files=428,
    keys= [
        "/ST_s-channel_4f_leptonDecays_TuneCP5_13TeV-amcatnlo-pythia8/RunIISummer19UL18MiniAOD-106X_upgrade2018_realistic_v11_L1v1-v1/MINIAODSIM",
    ],
    context=campaign_name,
)
...
dataset_st_t_t = od.Dataset(
    ...
    n_files=1077,
    keys= [
        "/ST_t-channel_top_4f_InclusiveDecays_TuneCP5_13TeV-powheg-madspin-pythia8/RunIISummer19UL18MiniAOD-106X_upgrade2018_realistic_v11_L1v1-v1/MINIAODSIM",
    ],
    context=campaign_name,
)
...
dataset_st_t_tbar = od.Dataset(
    ...
    n_files=637,
    keys=[
        "/ST_t-channel_antitop_4f_InclusiveDecays_TuneCP5_13TeV-powheg-madspin-pythia8/RunIISummer19UL18MiniAOD-106X_upgrade2018_realistic_v11_L1v1-v1/MINIAODSIM",
    ],
    context=campaign_name,
)
...
dataset_st_tW_t = od.Dataset(
    ...
    n_files=232,
    keys=[
         "/ST_tW_top_5f_NoFullyHadronicDecays_TuneCP5_13TeV-powheg-pythia8/RunIISummer19UL18MiniAOD-106X_upgrade2018_realistic_v11_L1v1-v1/MINIAODSIM",
    ],
    context=campaign_name,
)
...
dataset_st_tW_tbar = od.Dataset(
    ...
    n_files=247,
    keys=[
         "/ST_tW_antitop_5f_NoFullyHadronicDecays_TuneCP5_13TeV-powheg-pythia8/RunIISummer19UL18MiniAOD-106X_upgrade2018_realistic_v11_L1v1-v1/MINIAODSIM",
    ],
    context=campaign_name,
)
...
dataset_WW = od.Dataset(
    ...
    n_files=153,
    keys=[
        "/WW_TuneCP5_13TeV-pythia8/RunIISummer19UL18MiniAOD-106X_upgrade2018_realistic_v11_L1v1-v2/MINIAODSIM",
    ],
    context=campaign_name,
)
...
dataset_WZ = od.Dataset(
    ...
    n_files=70,
    keys=[
        "/WZ_TuneCP5_13TeV-pythia8/RunIISummer19UL18MiniAOD-106X_upgrade2018_realistic_v11_L1v1-v2/MINIAODSIM",
    ],
    context=campaign_name,
)
...
dataset_ZZ = od.Dataset(
    ...
    n_files=64,
    keys=[
        "/ZZ_TuneCP5_13TeV-pythia8/RunIISummer19UL18MiniAOD-106X_upgrade2018_realistic_v11_L1v1-v2/MINIAODSIM",
    ],
    context=campaign_name,
)
...
dataset_W_lep = od.Dataset(
    ...
    n_files=819,
    keys=[
        "/WJetsToLNu_TuneCP5_13TeV-madgraphMLM-pythia8/RunIISummer19UL18MiniAOD-106X_upgrade2018_realistic_v11_L1v1-v1/MINIAODSIM",
    ],
    context=campaign_name,
)
...
dataset_dy_lep_LO_50ToInf.add_process(process_dy_lep_50ToInf)
