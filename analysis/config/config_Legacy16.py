...
def create_config(base_cfg):
    # setup the config for legacy 2016 data
    from analysis.config.campaign_Legacy16 import campaign as campaign_Legacy16
    from analysis.config.jet_tagging_sf import ch_ee, ch_emu, ch_mumu
    cfg = base_cfg.copy(campaign=campaign_Legacy16)
    ...
    for dataset_name in dataset_names:
        dataset = campaign_Legacy16.get_dataset(dataset_name)
    ...
    cfg.set_aux("lumi_file", "/afs/cern.ch/cms/CAF/CMSCOMM/COMM_DQM/certification/Collisions16/13TeV/ReReco/"
        "Final/Cert_271036-284044_13TeV_ReReco_07Aug2017_Collisions16_JSON.txt")
    ...
    cfg.set_aux("jes_uncertainty_file", {
        ...
        "reduced": "https://cernbox.cern.ch/index.php/s/ujSKpZZSgczQZ3V/download",
    })
    ...
    cfg.set_aux("versions", {
        "WriteTrees": "prod7",  # reduced jes scheme
        "MergeTrees": "prod7",
        "MergeMetaData": "prod7",
        "WriteHistograms": "prod7",
        "MergeHistograms": "prod7",
        "MeasureCScaleFactors": "prod7",
        "MeasureScaleFactors": "prod7",
        "FitScaleFactors": "prod7",
        "BundleScaleFactors": "prod7",
        "MergeScaleFactorWeights": "prod7",
        "OptimizeBinning": "prod3",
        "CreateScaleFactorResults": "prod7",
    })
