...
def create_config(base_cfg):
    ...
    cfg.get_aux("binning")["lf"]["deepcsv"]["measurement"] = [
        -2.01, 0., 0.015, 0.03, 0.045, 0.06, 0.08, 0.11, 0.145, 0.195, 0.26, 0.33, 0.4184, 1.01
    ]
    cfg.get_aux("binning")["lf"]["deepcsv"]["plotting"] = [
        -2.01, 0., 0.015, 0.03, 0.045, 0.06, 0.08, 0.11, 0.145, 0.195, 0.26, 0.34, 0.4184,
        0.495, 0.57, 0.65, 0.725, 0.8, 0.85, 0.89, 0.93, 0.97, 1.01
    ]
    cfg.get_aux("binning")["lf"]["deepjet"]["measurement"] = [
        -2.01, 0., 0.01, 0.02, 0.03, 0.04, 0.055, 0.07, 0.095, 0.13, 0.18, 0.277, 1.01
    ]
    cfg.get_aux("binning")["lf"]["deepjet"]["plotting"] = [
        -2.01, 0., 0.01, 0.02, 0.03, 0.04, 0.055, 0.07, 0.095, 0.13, 0.18, 0.215, 0.277, 0.37,
