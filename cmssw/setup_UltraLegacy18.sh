    ...
    if [ ! -d "$CMSSW_BASE" ]; then
        ...
        if [ "$JTSF_ON_GRID" == "1" ]; then # unpack custom installation from .tgz
            ...
            if [ $JTSF_DIST_VERSION != "slc6" ]; then
                ...
                git fetch  https://github.com/yrath/cmssw.git deterministicSeeds_106X && git cherry-pick aa1ff1709e66e3c44570d562e77ad125559cc6f2

                # ECAL scale and resolution corrections
                # https://twiki.cern.ch/twiki/bin/view/CMS/EgammaUL2016To2018
                git cms-merge-topic jainshilpi:ULV1_backport106X_forUsers ##### for working in CMSSW_10_6_16 and beyond, please use this: git cms-merge-topic jainshilpi:ULV1_backport10616_forUsers
